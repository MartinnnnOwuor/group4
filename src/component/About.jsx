  ...
  return (
    <div className='container mx-auto px-4 py-8 bg-gray-50'>
      <div className='text-center mb-12'>
        ...
        <p className='text-lg mt-2 text-gray-600'>We are a dynamic team committed to providing you with unique accessories and a diverse range of high-quality products. Our mission is to make shopping a delightful experience with a focus on innovation and customer satisfaction.</p>
      </div>
      ...
      <div className='text-center mb-12'>
        ...
        <p className='text-gray-600'>At Ekart, we specialize in offering a curated selection of trendy fashion items, cutting-edge electronics, and essential home appliances. We strive to provide products that combine style, functionality, and value, ensuring you find exactly what you need.</p>
      </div>
